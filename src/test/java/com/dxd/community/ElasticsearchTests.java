...
public class ElasticsearchTests {
    ...
    //有些特殊情况，discussPostRepository无法解决向ES中增加和查询数据，需要使用elasticsearchRestTemplate
    @Autowired
    ...
    public void testInsertList() {
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(2, 0, 100, 0));
        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(16, 0, 100,0));
    }
...
//        discussPostRepository.save(discussPostMapper.selectDiscussPostById(231));
        ...
        post.setContent("我是新人，使劲灌水，向互联网大佬学习");
        discussPostRepository.save(post);
    }

//    @Test
//    public void testDelete() {
//        discussPostRepository.deleteById(4);
